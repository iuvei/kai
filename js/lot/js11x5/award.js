$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('jssc/' + _page, { t: Math.random() }, function (text) {
    ...
    var awardTick = function () {
        $.get('js11x5/getxjsscAwardData.do', { ajaxhandler: 'GetPk10AwardData', t: Math.random() }, function (data) {
    ...
    function loadAwardTimes() {
        $.get('js11x5/getxjsscAwardTimes.do', { ajaxhandler: 'GetPk10AwardTimes', t: Math.random() }, function (data) {
            if (data.current.awardNumbers != '') {
                var nums ;
                var str = "";
                nums = data.current.awardNumbers.split(',');
    ...
    function polling() {
        $.post('js11x5/getxjsscAwardTimes.do', {t: Math.random()}, function (data) {
            if(data.status == 2){
                return
            }
            if(data.current.awardNumbers==''){
...
function getHistoryData(count) {
    $.get("js11x5/getNewestRecord.do", { count:typeof(count)=="undefined"?16:count,t: Math.random() }, function (result) {
...
function updateHistoryRecord() {
    $.get('jssc/getNewestRecord.do', { ajaxhandler: 'GetNewestRecord', t: Math.random() }, function (data) {
