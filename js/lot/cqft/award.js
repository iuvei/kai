$(function () {
    ...
    var awardTick = function () {
        $.get('cqssc/getCqsscAwardData.do', {  t: Math.random() }, function (data) {
            ...
            if(data.current.periodNumber == currentPeriodNumber){
                window.setTimeout(awardTick, 3000);
            }
    ...
    function loadAwardTimes() {
        $.get('cqssc/getCqsscAwardTimes.do', { t: Math.random() }, function (data) {
            ...
            var qihao1 = parseInt(data.current.periodNumber1.substr(4))+1;
...
function updateHistoryRecord() {
    $.get('cqssc/getNewestRecord.do', { t: Math.random() }, function (data) {
