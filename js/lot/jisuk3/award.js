$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('jisuk3/' + _page, { t: Math.random() }, function (text) {
    ...
    var awardTick = function () {
        $.get('jisuk3/getJsk3AwardData.do', {  t: Math.random() }, function (data) {
    ...
    function loadAwardTimes() {
        $.get('jisuk3/getJsk3AwardTimes.do', {  t: Math.random() }, function (data) {
            if (data.current.awardNumbers != '') {
                var nums
                var str = "";
                nums = data.current.awardNumbers.split(',');
    ...
    function polling() {
        $.post('jisuk3/getJsk3AwardTimes.do', {t: Math.random()}, function (data) {
            if(data.status == 2){
                return
            }
            if(data.current.awardNumbers==''){
...
function updateHistoryRecord() {
    $.get('jisuk3/getNewestRecord.do', { t: Math.random() }, function (data) {
