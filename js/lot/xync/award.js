$(function () {
    ...
    var awardTick = function () {
        $.get('xync/getXyncAwardData.do', { ajaxhandler: 'GetXyncAwardData', t: Math.random() }, function (data) {
            requireCount += 1;
    ...
    function loadAwardTimes() {
        $.get('xync/getXyncAwardTimes.do', { ajaxhandler: 'GetXyncAwardTimes', t: Math.random() }, function (data) {
            //请求到数据后需要做的事情
...
function updateHistoryRecord() {
    $.get('xync/getNewestRecord.do', { ajaxhandler: 'GetNewestRecord', t: Math.random() }, function (data) {
