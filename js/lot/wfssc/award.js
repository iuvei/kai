$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('wfssc/' + _page, { t: Math.random() }, function (text) {
    ...
    var awardTick = function () {
        $.get('wfssc/getCqsscAwardData.do', {  t: Math.random() }, function (data) {
    ...
    function loadAwardTimes() {
        $.get('wfssc/getCqsscAwardTimes.do', { t: Math.random() }, function (data) {
            if (data.current.awardNumbers != '') {
                var nums ;
                var str = "";
                nums = data.current.awardNumbers.split(',');
...
function updateHistoryRecord() {
    $.get('wfssc/getNewestRecord.do', { t: Math.random() }, function (data) {
