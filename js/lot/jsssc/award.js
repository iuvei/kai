$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('jsssc/' + _page, { t: Math.random() }, function (text) {
    ...
    var awardTick = function () {
        $.get('jsssc/getCqsscAwardData.do', {  t: Math.random() }, function (data) {
            requireCount += 1;
    ...
    function loadAwardTimes() {
        $.get('jsssc/getCqsscAwardTimes.do', { t: Math.random() }, function (data) {
            //请求到数据后需要做的事情
...
function updateHistoryRecord() {
    $.get('jsssc/getNewestRecord.do', { t: Math.random() }, function (data) {
