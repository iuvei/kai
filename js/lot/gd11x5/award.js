$(function () {
    ...
    function loadAwardTimes() {
        $.get('gd11x5/getxjsscAwardTimes.do', { ajaxhandler: 'GetxjsscAwardTimes', t: Math.random() }, function (data) {
            //请求到数据后需要做的事情
...
function updateHistoryRecord() {
    $.get('gd11x5/getNewestRecord.do', { ajaxhandler: 'GetNewestRecord', t: Math.random() }, function (data) {
