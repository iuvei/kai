$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('sfpk10/' + _page, { t: Math.random() }, function (text) {
    ...
    var awardTick = function () {
        $.get('sfpk10/getPk10AwardData.do', { ajaxhandler: 'GetPk10AwardData', t: Math.random() }, function (data) {
            //计数请求次数
            requireCount += 1;
    ...
    function loadAwardTimes() {
        $.get('sfpk10/getPk10AwardTimes.do', { ajaxhandler: 'GetPk10AwardTimes', t: Math.random() }, function (data) {
            //请求到数据后需要做的事情
            ...
            $(" .lot-award .currentAward .period-info .period-leave").html(data.firstPeriod+1152-cpNumber);
...
function updateHistoryRecord() {
    $.get('sfpk10/getNewestRecord.do', { ajaxhandler: 'GetNewestRecord', t: Math.random() }, function (data) {
