...
animateMethod.loadingList = function (n, i) {
    ...
    animateMethod.loadingList = function (n, i) {
        ...
        for (var a = 0, t = n.length; a < t; a++) {
            "#gxklsf" != i && n[a] >= 19 && $(e).find("li").eq(a).addClass("numred"), a < n.length && $(e).find("li:last-child").css({"margin-right": "0"}), $(e).find("li").eq(a).css({paddingTop: "0px"}), $(e).find("li").eq(a).text(n[a]);
            var r = 50 * excutenum();
