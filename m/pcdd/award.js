...
$(function () {
    ...
    var awardTick = function () {
        $.post('../../pcdd/getCqsscAwardTimes.do', { t: Math.random() }, function (data) {
...
function getHistoryData(count,date) {
    $.get("../../pcdd/getHistoryData.do", { count:count,date:date,t: Math.random() }, function (result) {
...
function getPkData(date) {
    $.get("../../pcdd/getHistoryData.do", {date: date, page: 1, offset: 15, t: Math.random()}, function (result) {
        if (result.count) {
