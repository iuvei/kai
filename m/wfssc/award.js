$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('http://m.qx66.com/wfssc/' + _page, { t: Math.random() }, function (text) {
    ...
    function loadAwardTimes() {
        $.post('../../wfssc/getCqsscAwardTimes.do', {t: Math.random() }, function (data) {
...
function getHistoryData(count,date) {
    $.get("../../wfssc/getHistoryData.do", { count:count,date:date,t: Math.random() }, function (result) {
...
function getPkData(date) {
    $.get("../../wfssc/getHistoryData.do", {date: date, page: 1, offset: 15, t: Math.random()}, function (result) {
        if (result.count) {
