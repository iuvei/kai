$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('http://m.qx66.com/jsssc/' + _page, { t: Math.random() }, function (text) {
    ...
    var awardTick = function () {
        $.post('../../jsssc/getCqsscAwardTimes.do', { t: Math.random() }, function (data) {
            //计数请求次数
            requireCount += 1;
    ...
    function loadAwardTimes() {
        $.post('../../jsssc/getPk10AwardTimes.do', {t: Math.random() }, function (data) {
