    ...
    $.get("../../jsssc/getHistoryData.do", { count:count,date:date,t: Math.random() }, function (result) {
        if(result&&result.rows){
        	...
        	for(var i in result.rows){
                ...
                html += '<div class="bt-jg">总和 <span>18</span> <span>大</span><span>单</span> <span>龙</span>前三<span class="span-2">杂六</span>中三<span class="span-2">散号</span>后三<span class="span-2">杂六</span></div></td>';
