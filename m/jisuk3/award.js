...
$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('http://m.qx66.com/jisuk3/' + _page, { t: Math.random() }, function (text) {
    ...
    function loadAwardTimes() {
        $.post('../../jisuk3/getPk10AwardTimes.do', {t: Math.random() }, function (data) {
...
function getHistoryData(count,date) {
    $.get("../../jisuk3/getHistoryData.do", { count:count,date:date,t: Math.random() }, function (result) {
...
function getPkData(date) {
    $.get("../../jisuk3/getHistoryData.do", {date: date, page: 1, offset: 15, t: Math.random()}, function (result) {
        if (result.count) {
            loadData(result.count);
            loadpage(date,'jisuk3');
        }
    }, "json");
