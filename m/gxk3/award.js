...
$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('http://m.qx66.com/gxk3/' + _page, { t: Math.random() }, function (text) {
    ...
    var awardTick = function () {
        $.post('../../gxk3/getPk10AwardTimes.do', { t: Math.random() }, function (data) {
...
function getHistoryData(count,date) {
    $.get("../../gxk3/getHistoryData.do", { count:count,date:date,t: Math.random() }, function (result) {
...
function getPkData(date) {
    $.get("../../gxk3/getHistoryData.do", {date: date, page: 1, offset: 15, t: Math.random()}, function (result) {
        if (result.count) {
