...
$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('http://m.qx66.com/tcpk10/' + _page, { t: Math.random() }, function (text) {
...
function getHistoryData(count,date) {
    ...
    $.get("../../tcpk10/getHistoryData.do", { count:count,date:date,t: Math.random() }, function (result) {
        if(result&&result.rows){
        	...
        	for(var i in result.rows){
				...
				html += '<tr>';
        		html += '<td width="20%">' + data.termNum.substring(8) +'期</br>';
                ...
                html += ' <div class="bt-jg"><span>龙</span><span>虎</span><span>龙</span><span>虎</span><span>龙</span><span>|</span> 冠亚和： <span>18</span> <span>大</span><span>单</span>  </div></td>';
