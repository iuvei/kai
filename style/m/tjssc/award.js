...
$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('http://m.qx66.com/tjssc/' + _page, { t: Math.random() }, function (text) {
    ...
    var awardTick = function () {
        $.post('../../tjssc/gettjsscAwardTimes.do', { t: Math.random() }, function (data) {
            //计数请求次数
            requireCount += 1;
...
function getHistoryData(count,date) {
    ...
    $.get("../../tjssc/getHistoryData.do", { count:count,date:date,t: Math.random() }, function (result) {
