...
$(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('http://m.qx66.com/xync/' + _page, { t: Math.random() }, function (text) {
    ...
    var awardTick = function () {
        $.post('../../xync/getPk10AwardTimes.do', { t: Math.random() }, function (data) {
            //计数请求次数
...
function getHistoryData(count,date) {
    ...
    $.get("../../xync/getHistoryData.do", { count:count,date:date,t: Math.random() }, function (result) {
