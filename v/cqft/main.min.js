...
!function (t) {
    var e = function () {
        ...
        return t.getData = function () {
            ...
            //console.log("123"+CommonVariable.awardStatus);
...
!function (t) {
    var e = function (t) {
        ...
        return __extends(e, t), e.prototype.subscribe = function (t, e, r) {
            ...
            for (var t = 0; 5 > t; t++) this["bit" + 2].texture = RES.getRes("LotteryNum0011")//开奖中问号
        }, e.prototype.onGetNumber = function (t) {
            var e = CommonVariable.resultArray;
            //console.log(CommonVariable.resultArray);
                var hm_he = Number(e[0]) + Number(e[1])+ Number(e[2])+ Number(e[3])+ Number(e[4]),i=0;
                //console.log(hm_he);
                if(hm_he %4 == 0){
                    i=4;
                }if(hm_he %4 == 1){
                ...
                /*   "0" == i && (i = "10");
                    var n ;
                    n = i;*/
                this["bit" + 2].texture = RES.getRes("LotteryNum00" +0+ i)
                //console.log("LotteryNum00" + i),
             4 == t && TimerDelayCaller.addCallerOnce(null, ConcreteSubject.notify, ConcreteSubject, 500, SubjectTypes.SHOW_VICTORY)
...
!function (t) {
    var e = function () {
        ...
        return e.prototype.subscribe = function (t, e, r) {
            ...
            } else this.requestID = setInterval(t.DataRequester.getData.bind(this), 1e3)
        }, e
    }();
...
var Tween = egret.Tween, CommonVariable = localData.CommonVariable, Cache = localData.Cache,
    ...
    GameApplication = function (t) {
        function e() {
            var e = t.call(this) || this;
            if (e.versionDate = 20170602150, e.initParams(), ActivateRunTimes.start(), e.addEventListener(egret.Event.ADDED_TO_STAGE, e.onAddToStage, e), egret.Capabilities.isMobile) {
