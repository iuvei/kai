    ...
    var e = function (e) {
        ...
        return __extends(r, e), r.init = function () {
            ...
            if (e) {
                ...
                this.hasData = !0;
                var a = !1;
                void 0 != this.currentperiodNumber && this.currentperiodNumber != e.last_opencode.expect && (egret.clearInterval(this._getId), this._getId = 0, a = !0);

                var n = parseInt(e.present.opentime_remaining * 1e3);
                !a && n < 4e3 ? this.nextawardTimeInterval = 4e3 : this.nextawardTimeInterval = n ;//开奖倒计时
                    this.currentperiodNumber = e.last_opencode.expect;//本期期号

                    this.currentawardTime = e.last_opencode.opentime;//本期开奖时间

                    /*this.currentPeriodDate = e.current.periodDate;//？*/
                    this.currentawardNumbers = [];

                for (var i = e.last_opencode.opencode.split(","), s = i.length, o = 0; o < s; ++o) r.currentawardNumbers[o] = parseInt(i[o]);
                this.nextperiodNumber = e.present.expect;//下期期号
                    this.nextawardTime = e.present.opentimestamp;//下期开奖时间
