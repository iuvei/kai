...
!function (e) {
    var t = function () {
        ...
        return t.prototype, e.getData = function () {
            ...
            a.time = i.present.opentime.toString();

            if(a.current.periodNumber==undefined||a.current.periodNumber==i.last_opencode.expect.toString()){
                CommonVariable.awardStatus = 0;
            }else {
                CommonVariable.awardStatus=2.5;
            };

            a.current.periodNumber = i.last_opencode.expect.toString();//本期期号
            //console.log(a);
            //console.log(InitConfig.req_host);
            var n = i.last_opencode.opentime.toString().split(":");a.current.awardTime = n[0] + ":" + n[1], //本期开奖时间
            a.current.awardNumbers = i.last_opencode.opencode.toString(),//本期开奖号码
            //console.log(i.last_opencode.opencode.toString());
            a.next.periodNumber = i.present.expect.toString(),//下期期号
            n = i.present.opentimestamp.toString().split(":"), a.next.awardTime = n[0] + ":" + n[1],//下期开奖时间
            a.next.awardTimeInterval = i.present.opentime_remaining.toString(),//i.present.opentime_remaining.toString()+10,
            a.next.delayTimeInterval = i.present.opentime_remaining.toString(),//i.present.opentime_remaining.toString(),
            localData.CommonVariable.resultArray = a.current.awardNumbers.split(",");


            if(i.present.expect.toString() - i.last_opencode.expect.toString() == 2 ){
