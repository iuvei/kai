...
var SubjectTypes = function () {
    ...
    var t = (__define, e);
    return t.prototype,
        e.LINK_FAULT = "linkFault",
        e.DYNAMIC_COMPLETE = "dynamicComplete",
        e.APP_START = "appStart",
        e.OVER_TIME = "overTime",
        e.SOUND_RESTART = "soundRestart",
        e.GET_DATA = "getData",
        e.GET_REALDATA = "getRealData",
        e.GET_RECORD = "getRecord",
        e.GAME_START = "gameStart",
        e.TAKE_REALDATA = "takeRealData",
        e.TAKE_SPACE = "takeSpace",
        e.GAME_RANKING = "gameRanking",
        e.GAME_SHOWRANK = "gameShowRank",
        e.GAME_BGMOVE = "gameBgMove",
        e.GAME_BOATCONTAINERMOVE = "gameBoatContainerMove",
        e.GAME_SCREENREADY = "gameScreenReady",
        e.GAME_SHOWLABEL = "gameShowLabel",
        e.GAME_END = "gameEnd",
        e.GAME_INIT = "gameInit",
        e.GAME_UNMONI = "gameUnMoni",
        e.GAME_MONI = "gameMoni",
        e.SHOW_BTN = "showBtn",
        e.HIDE_BTN = "hideBtn", e
}();
...
!function (e) {
    var t = function (e) {
        ...
        return a.addFrameScript = function (e, t, i, r) {
            ...
            if (void 0 === i && (i = !1), void 0 === r && (r = this.$driverType), void 0 === a && (a = this.playInterval), 1 > e || t > this.$totalFrames) throw new Error("循环播放片段起始帧或结束帧超出范围！");
            if (e > t) throw new Error("循环播放片段起始帧号不能大于结束帧号！");
...
!function (e) {
    var t = function (e) {
        ...
        return n.reconstruct = function (e, t, i, r) {
            if (void 0 === t && (t = 1), void 0 === i && (i = !0), void 0 === r && (r = disTypes.BitmapAlignEnum[0]), !e || e.length < 1) throw new Error("textureInfoList不能为空, 并且长度不能小于1");
            ...
            if (1 > t || t > this.$totalFrames) throw new Error("初始帧start超出有效范围");
            ...
            var t = RES.getRes(e);
            return this.$currentTextureName != e ? (this.$currentTextureName = e, e && (t || trace("无法获取有效的 Texture: " + e + "，请检查名称拼写，或确认是否已经正常加载该资源")), t) : (this.$currentTextureName = e, t)
        }, n.push = function (e) {
            ...
            if (void 0 === i && (i = this), void 0 === r && (r = !0), isNaN(Math.floor(e)) || Math.floor(e) < 0 || Math.floor(e) > this.$totalFrames - 1) throw new Error("事件帧序号超出有效范围");
            ...
            if (Math.floor(e) < 0 || Math.floor(e) > this.$totalFrames - 1) throw new Error("事件帧序号超出有效范围");
            ...
            return e = Math.floor(e), e >= this.$partHeadList.length || e < -this.$partHeadList.length ? (trace("提示: 提供给 getPartHeadAt 的索引值超出片段头列表范围"), NaN) : (0 > e && (e = this.$partHeadList.length + e), this.$partHeadList[e])
        }, n.getPartTailAt = function (e) {
            return e = Math.floor(e), e >= this.$partTailList.length || e < -this.$partTailList.length ? (trace("提示: 提供给 getPartTailAt 的索引值超出片段尾列表范围"), NaN) : (0 > e && (e = this.$partTailList.length + e), this.$partTailList[e])
            ...
            return e = Math.floor(e), e >= this.$partArray.length || e < -this.$partArray.length ? (trace("提示: 提供给 getPartHeadAt 的索引值超出片段头列表范围"), null) : (0 > e && (e = this.$partArray.length + e), new a(this.$partHeadList[e], this.$partTailList[e]))
        }, n.getPlayPartIndexByFrame = function (e) {
            if (1 > e || e > this.totalFrames) throw new Error("帧号超出有效范围！");
            e = Math.floor(e);
            ...
            if (void 0 === e && (e = disTypes.DriverType.FRAME), void 0 === t && (t = 1), 0 >= t) throw new Error("驱动间隔不能等于或小于0！");
    ...
    var i = function () {
        ...
        return t.prototype, e.createInfo = function (e, t, i, a, n, s) {
            if (void 0 === t && (t = null), void 0 === i && (i = 0), void 0 === a && (a = 1), void 0 === n && (n = 0), void 0 === s && (s = 0), 1 > e) throw new Error("Texture对象列表长度不能小于1");
            if (1 > a) throw new Error("Texture对象的序号长度不能小于1");
            ...
            if (void 0 === t && (t = null), void 0 === i && (i = 0), void 0 === a && (a = 0), 1 > e) throw new Error("Texture对象列表长度不能小于1");
...
!function (e) {
    var t = function (e) {
        ...
        return a.reconstruct = function (e, t, i, r, a, n) {
            if (void 0 === t && (t = null), void 0 === i && (i = 0), void 0 === r && (r = 1), void 0 === a && (a = 1), void 0 === n && (n = !0), 1 > e) throw new Error("Texture对象列表长度不能小于1");
            if (1 > a || a > e) throw new Error("初始帧start超出有效范围");
            ...
            var t = RES.getRes(e);
            return t || trace("无法获取有效的 Texture: " + e + "，请检查名称拼写，或确认是否已经正常加载该资源"), t
...
!function (e) {
    var t = function (e) {
        ...
        return a.reconstruct = function (e, t, i, r) {
            if (void 0 === t && (t = null), void 0 === i && (i = 1), void 0 === r && (r = !0), 1 > e) throw new Error("totalFrames 不能小于1");
            if (this.$totalFrames = Math.floor(e), 1 > i || i > this.$totalFrames) throw new Error("startFrame 超出有效范围");
            ...
            if (this.anmArray || (this.anmArray = new Array), this.$totalFrames != e.totalFrames) throw new Error("子动画与" + this.__class__ + "的 totalFrames 不一致");
...
!function (e) {
    var t = function () {
        ...
        return i.prototype, t(e, "isOpen", function () {
            ...
            if (void 0 === r && (r = 1), !i) throw new Error("用于注册的音效不能为null，请检查声音文件是否已成功加载(url是否正确？是否已添加到groups的keys？)");
            if (e.soundObject || (e.soundObject = new Object, e.defaultVolumeObject = new Object), e.soundObject[t]) throw new Error("该音效名称已被注册");
            i.type = egret.Sound.MUSIC, e.soundObject[t] = i, e.defaultVolumeObject[t] = r
        }, e.initAllSoundWithExtreme = function () {
            if (!e.soundObject) throw new Error("该音效尚未被注册和实例化");
            var t = e.isOpen;
            e.isOpen = !0;
            for (var i in e.soundObject) e.playSound(i, 0, 1, 0, 0);
            e.stopAllSound(), e.isOpen = t
        }, e.playSoundSingle = function (t, i, r, a, n) {
            if (void 0 === i && (i = 0), void 0 === r && (r = 1), void 0 === a && (a = i), void 0 === n && (n = NaN), !e.soundObject) throw new Error("该音效尚未被注册和实例化");
            if (!e.soundObject[t]) throw new Error("该音效尚未被注册和实例化");
...
!function (e) {
    var t = function () {
        ...
        return i.prototype, t(e, "isOpen", function () {
            ...
            if (void 0 === r && (r = 1), !i) throw new Error("用于注册的音乐不能为null，请检查声音文件是否已成功加载(url是否正确？是否已添加到groups的keys？)");
            if (e.soundObject || (e.soundObject = new Object, e.defaultVolumeObject = new Object), e.soundObject[t]) throw new Error("该音乐名称已被注册");
            i.type = egret.Sound.MUSIC, e.soundObject[t] = i, e.defaultVolumeObject[t] = r
        }, e.initAllSoundWithExtreme = function () {
            if (!e.soundObject) throw new Error("该音乐尚未被注册和实例化");
            var t = e.isOpen;
            e.isOpen = !0;
            for (var i in e.soundObject) e.playSound(i, 0, 1, 0, 0);
            e.stopAllSound(), e.isOpen = t
        }, e.playSoundSingle = function (t, i, r, a, n) {
            if (void 0 === i && (i = 0), void 0 === r && (r = 1), void 0 === a && (a = i), void 0 === n && (n = NaN), !e.soundObject) throw new Error("该音乐尚未被注册和实例化");
            if (!e.soundObject[t]) throw new Error("该音乐尚未被注册和实例化");
            e.stopAllSound(), e.playSound(t, i, r, a, n)
        }, e.playSound = function (t, i, r, a, n) {
            if (void 0 === i && (i = 0), void 0 === r && (r = 1), void 0 === a && (a = i), void 0 === n && (n = NaN), !e.soundObject) throw new Error("该音乐尚未被注册和实例化");
            if (!e.soundObject[t]) throw new Error("该音乐尚未被注册和实例化");
...
var BrowserInfo = function () {
    function e() {
        this.browserKey = "unkonw", this.isAdvise = !1, this.description = "不知名浏览器", this.fullScreen = 0, this.assess = "", this.defectList = [], this.isAutoPlaySound = !0, this.isControllable = !0, this.isSmooth = !0, this.isWebgl = !0, this.isPluralSounds = !0, this.isOrientation = !0
    }
...
var ActivateRunTimes = function () {
    ...
    return i.prototype, e.start = function () {
        ...
        return e.$isStartUsing ? Math.round(e.$activateRunTime) : (trace("ActivateRunTimes.start() 未被启用"), NaN)
    }), t(e, "startedTimes", function () {
        return e.$isStartUsing ? Math.round(egret.getTimer() - e.getTimerOnStart) : (trace("ActivateRunTimes.start() 未被启用"), NaN)
    }), t(e, "deviationTotalTimes", function () {
        return e.$isStartUsing ? Math.round(e.startedTimes - e.$activateRunTime) : (trace("ActivateRunTimes.start() 未被启用"), NaN)
    }), t(e, "deviationCurrentTimes", function () {
        return e.$isStartUsing ? Math.round(egret.getTimer() - e.$lastStepTime) : (trace("ActivateRunTimes.start() 未被启用"), NaN)
...
var DragonBonesDataTree = function () {
    ...
    return t.prototype, e.read = function (t, i) {
        ...
        trace("读取信息错误,请检查龙骨文件是否存在，或文件的url是否正确")
    }, e.onComplete = function (t) {
        var i = JSON.parse(t.target.data), r = i.armature;
        console.log(i)
        console.log(t)
        trace("数据版本:", i.version), trace("帧频:", i.frameRate, "fps"), trace("文件名:", i.name);
        for (var a = 0, n = 0; n < r.length; n++) r[n] && r[n].name && a++;
        if (trace("骨架数量:", a), e.detailed) {
            trace("骨架名称:");
            for (var s = 0; s < r.length; s++) r[s] && r[s].name && trace("    [" + s + "] " + r[s].name)
        }
        for (s = 0; s < r.length; s++) {
            trace("\n\n    " + i.name + " 数据骨架列表节点下标为 [" + s + "] 的骨架名称(data根节点.armature[" + s + "].name):", r[s].name), e.detailed && trace("\n        data根节点.armature[" + s + "] 拥有以下子节点对象：");
            var o, h = r[s];
            if (e.detailed) for (o in h) trace("                                " + o);
            o = "animation";
            var l = h.animation, c = "";
            trace("\n        data根节点.armature[" + s + "] 节点的骨骼动画信息列表(长度为 " + l.length + "):");
            for (var u in l) e.detailed ? Number(i.version) >= 4 ? trace("                                动画名称(animation[" + u + "].name):" + l[u].name, "  总帧数(animation[" + u + "].duration):" + (l[u].duration + 1), "  默认循环次数(animation[" + u + "].playTimes):" + (void 0 == l[u].playTimes ? 1 : l[u].playTimes), "  预计默认循环耗时:" + (l[u].duration / i.frameRate).toFixed(4)) : trace("                                动画名称(animation[" + u + "].name):" + l[u].name, "  总帧数(animation[" + u + "].duration):" + (l[u].duration + 1), "  默认循环次数(animation[" + u + "].loop):" + (void 0 == l[u].loop ? 1 : l[u].loop), "  预计默认循环耗时:" + (l[u].duration / i.frameRate).toFixed(4)) : c += "\n                                " + l[u].name;
            ...
            trace("\n        data根节点.armature[" + s + "] 节点的骨骼部件名称列表(长度为 " + m.length + "):");
            for (var g in m) {
                var y = "undefined";
                for (var b in d) {
                    var v = d[b];
                ...
                e.detailed ? "undefined" == y ? trace("                                骨骼名称(bone[" + g + "].name):" + m[g].name, "  ------未绑定插槽------") : Number(i.version) >= 4 ? trace("                                骨骼名称(bone[" + g + "].name):" + m[g].name, "  绑定的插槽名称(slot[" + b + "].name):" + y) : trace("                                骨骼名称(bone[" + g + "].name):" + m[g].name, "  绑定的插槽名称(skin[0].slot[" + b + "].name):" + y) : c += "\n                                " + m[g].name
            }
            if (e.detailed || trace(c), e.detailed) {
                var f = h.skin;
                trace("\n        data根节点.armature[" + s + "] 节点的皮肤信息列表(长度为 " + f.length + "):");
                for (var p = 0; p < f.length; p++) {
                    var d = f[p].slot;
                    trace("\n            下标为 [" + p + "] 的皮肤名称(skin[" + p + "].name):" + f[p].name + " , 插槽信息列表(长度为" + d.length + "): ");
                    for (var b in d) {
                        var C = "", A = d[b].display;
                        for (var E in A) C += "   " + A[E].name;
                        var S = "";
                        A.length > 1 && (S = "(" + A.length + "个)"), trace(A.length > 0 ? "                                插槽名称 (skin[" + p + "].slot[" + b + "].name):" + d[b].name + "    嵌入的图像列表(skin[" + p + "].slot[" + b + "].display)清单" + S + ":  " + C : "                                插槽名称 (skin[" + p + "].slot[" + b + "].name):" + d[b].name + "    ------未嵌入图像------")
                    }
                }
            }
            trace("\n>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"), trace("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<")
...
var FrameDelayCaller = function () {
    ...
    return i.prototype, e.addCallerOnce = function (t, i, r, a) {
        ...
        if (1 > a && (a = 1, trace("提示：间隔帧数intervalFrames 不应该小于1")), null == i) throw new Error("错误：提供给 FrameDelayCaller 的回调函数不能为null");
        var h;
...
var popupAble = !0, TimerDelayCaller = function () {
    ...
    return i.prototype, e.addCallerOnce = function (t, i, r, a) {
        ...
        void 0 === n && (n = 0);
        for (var s = [], o = 5; o < arguments.length; o++) s[o - 5] = arguments[o];
        if (0 > n) throw new Error("参数 repeatCount 不能小于0");
        e.$useAbleID++;
        ...
        if (e.timerFromID[t]) {
            var i = e.timerFromID[t];
            i.running && (ActivateRunTimes.isStartUsing ? e.passTimeFromID[t] = ActivateRunTimes.activateTimes - e.startTimeFromID[t] : trace("ActivateRunTimes.start() 未被启用，无法计算中继时间"), i.stop())
        }
    }, e.resumeCallerByID = function (t, i) {
        if (void 0 === i && (i = !0), e.timerFromID[t]) {
            var r = e.timerFromID[t];
            r.running || (i && (ActivateRunTimes.isStartUsing ? r.delay > e.passTimeFromID[t] ? r.delay -= e.passTimeFromID[t] : r.delay = 0 : trace("ActivateRunTimes.start() 未被启用，无法计算中继时间")), e.startTimeFromID[t] = ActivateRunTimes.activateTimes, r.start())
        }
    }, e.clearCallerAt = function (t) {
...
var Bitmap = egret.Bitmap, TextField = egret.TextField, DisplayObjectContainer = egret.DisplayObjectContainer,
    ...
    SoundEffectManager = esm.SoundEffectManager, GameApplication = function (e) {
        function t() {
            if (e.call(this), this.versionDate = 201606281757, this.loadedCount = 0, AboutBrowser.info.isWebgl || ("iOS" == egret.Capabilities.os ? popup("本视频需要启动WebGL渲染加速引擎。如果播放视频时出现卡顿、延迟、降帧、破图等现象，建议您更换其他(如Safari、Chrome、Firefox等)IOS浏览器。") : "Android" == egret.Capabilities.os && popup("本视频需要启动WebGL渲染加速引擎，而您当前所使用的浏览器可能不支持此功能。\n如果出现卡顿、延迟、降帧、破图等现象，建议您更换其他(如QQ、360、百度等)浏览器。")), AboutBrowser.info.isOrientation || popup("您的浏览器可能不支持重力感应，无法实现转屏效果。建议您更换其他浏览器"), this.addEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this), "iOS" == egret.Capabilities.os) {
        ...
        return r.subscribe = function (e, t, i) {
            ...
            if (ActivateRunTimes.deviationCurrentTimes > 3e3) {
                for (trace("等待超时,自动重新载入"), SoundEffectManager.stopAllSound(), this.loadingLayer.addChild(this.loadingView), this.loadingView.replay(), ConcreteSubject.notify(SubjectTypes.OVER_TIME), FrameDelayCaller.clearAllCallers(), TimerDelayCaller.clearAllCallers(), egret.Tween.removeAllTweens(), clearInterval(this.timeID), ActivateRunTimes.stop(), CommonVariable.isSimulating = !1, CommonVariable.awardStatus = 0; this.globalEffectLayer.numChildren > 0;) this.globalEffectLayer.removeChildAt(0);
...
!function (e) {
    var t = function () {
        function e() {
            throw new Error(e.__class__ + " 是静态方法集成类，不需要实例化")
        }
        ...
        return t.prototype, e.getData = function () {
            ...
            t=connect.NetworkConnector.connectToURL(apiurl, e.onGetData, e);

        }, e.onGetData = function (t) {
            if (t == connect.NetworkConnector.CONNECT_FAULT)
                return void(e.dataRequestTimes < 10 ? (egret.setTimeout(e.getData, e, 500), e.dataRequestTimes++, trace("reconnect  " + e.dataRequestTimes)) : (ConcreteSubject.notify(SubjectTypes.LINK_FAULT), trace("多次访问服务器失败，请检查网络链接并手动刷新页面")));
            try {
                var i = JSON.parse(t)
                //console.log(e.getData);
                // console.log(t);
            } catch (r) {
                return trace("JSON数据解析异常，重新请求数据!"), void e.getData()
            }
            ...
            a.time = i.datas.present.opentime.toString();

            if(a.current.periodNumber==undefined||a.current.periodNumber==i.datas.last_opencode.expect.toString()){
                CommonVariable.awardStatus = 0;
            }else {
                CommonVariable.awardStatus=2.5;
            };

            a.current.periodNumber = i.datas.last_opencode.expect.toString();//本期期号
            //console.log(a);
            //console.log(InitConfig.req_host);
            var n = i.datas.present.start_buytimestamp.toString().split(":");a.current.awardTime = n[0] + ":" + n[1], //本期开奖时间
            a.current.awardNumbers = i.datas.last_opencode.opencode.toString(),//本期开奖号码
            //console.log(i.last_opencode.opencode.toString());
            a.next.periodNumber = i.datas.present.expect.toString(),//下期期号
            n = i.datas.present.opentimestamp.toString().split(":"), a.next.awardTime = n[0] + ":" + n[1],//下期开奖时间
            a.next.awardTimeInterval = i.datas.present.opentime_remaining.toString(),//i.present.opentime_remaining.toString()+10,
            a.next.delayTimeInterval = i.datas.present.opentime_remaining.toString(),//i.present.opentime_remaining.toString(),
            localData.CommonVariable.resultArray = a.current.awardNumbers.split(",");


            if(i.datas.present.expect.toString() - i.datas.last_opencode.expect.toString() == 2 ){
                CommonVariable.awardStatus = 1;
            }
            localData.CommonVariable.timeInterval = Math.round(Number(localData.Cache.data.next.awardTimeInterval) / 1e3 + Number(localData.Cache.data.next.delayTimeInterval));
                CommonVariable.awardStatus < 2 ? ConcreteSubject.notify(SubjectTypes.GET_DATA) :
                    a.next.awardTimeInterval > 0 && ConcreteSubject.notify(SubjectTypes.GET_REALDATA);
...
!function (e) {
    var t = function () {
        ...
        return i.subscribe = function (e, t, i) {
            ...
            for (var e = 0; 10 > e; e++)
                this.bppArray[e].readyToRun(),
                this.bppArray[e].startToRun();
            //console.log(this.bppArray);
            CommonVariable.awardStatus = 3,
                SoundEffectManager.playSoundSingle(SoundNames.RUNNING, 0, 0)
...
!function (e) {
    var t = function () {
        ...
        return i.subscribe = function (e, t, i) {
            ...
            t.texture = RES.getRes("infoBoardQH_png"), r.texture = RES.getRes("infoBoardLH_png"), i.texture = RES.getRes("infoBoardGYJH_png"), a.texture = RES.getRes("awardTime_png"), n.texture = RES.getRes("nextPeriod_png"), t.scaleX = t.scaleY = 1 / .7, this.container.addChild(t), t.x = 50, t.y = 536, i.scaleX = i.scaleY = 1 / .7, this.container.addChild(i), i.x = 438, i.y = 536, r.scaleX = r.scaleY = 1 / .7, this.container.addChild(r), r.x = 731, r.y = 536, a.scaleX = a.scaleY = 1 / .7, this.container.addChild(a), a.x = 810, a.y = 18, n.scaleX = n.scaleY = 1 / .7, this.container.addChild(n), n.x = 8, n.y = 18, this.luzhuContainer = new Sprite, this.next_periodNumber_txt = new TextField, this.next_periodNumber_txt.fontFamily = "Microsoft YaHei", this.next_periodNumber_txt.size = 24, this.next_periodNumber_txt.bold = !1, this.next_periodNumber_txt.textAlign = egret.HorizontalAlign.LEFT, this.next_periodNumber_txt.x = 8, this.next_periodNumber_txt.y = 55, this.next_periodNumber_txt.textColor = 16054049, this.container.addChild(this.next_periodNumber_txt), this.next_awardTime_txt = new TextField, this.next_awardTime_txt.fontFamily = "Microsoft YaHei", this.next_awardTime_txt.size = 30, this.next_awardTime_txt.bold = !1, this.next_awardTime_txt.textAlign = egret.HorizontalAlign.LEFT, this.next_awardTime_txt.x = 810, this.next_awardTime_txt.y = 55, this.next_awardTime_txt.textColor = 16054049, this.container.addChild(this.next_awardTime_txt), this.current_awardDate_txt = new TextField, this.current_awardDate_txt.fontFamily = "Microsoft YaHei", this.current_awardDate_txt.size = 24, this.current_awardDate_txt.bold = !0, this.current_awardDate_txt.textAlign = egret.HorizontalAlign.CENTER, this.current_awardDate_txt.x = 45, this.current_awardDate_txt.y = 575, this.current_awardDate_txt.textColor = 14088191, this.container.addChild(this.current_awardDate_txt), this.current_awardTime_txt = new TextField, this.current_awardTime_txt.fontFamily = "Microsoft YaHei", this.current_awardTime_txt.size = 24, this.current_awardTime_txt.bold = !0, this.current_awardTime_txt.textAlign = egret.HorizontalAlign.CENTER, this.current_awardTime_txt.x = 213, this.current_awardTime_txt.y = 575, this.current_awardTime_txt.textColor = 14088191, this.container.addChild(this.current_awardTime_txt), this.current_periodNumber_txt = new TextField, this.current_periodNumber_txt.fontFamily = "Microsoft YaHei", this.current_periodNumber_txt.size = 24, this.current_periodNumber_txt.bold = !0, this.current_periodNumber_txt.textAlign = egret.HorizontalAlign.CENTER, this.current_periodNumber_txt.width = 180, this.current_periodNumber_txt.x = 110, this.current_periodNumber_txt.y = 538, this.current_periodNumber_txt.textColor = 14088191, this.container.addChild(this.current_periodNumber_txt), this.zh_txt = new TextField, this.zh_txt.fontFamily = "Microsoft YaHei", this.zh_txt.size = 24, this.zh_txt.bold = !0, this.zh_txt.width = 30, this.zh_txt.textAlign = egret.HorizontalAlign.CENTER, this.zh_txt.x = 419, this.zh_txt.y = 575, this.zh_txt.textColor = 14088191, this.container.addChild(this.luzhuContainer), this.luzhuContainer.addChild(this.zh_txt), this.dx_anm = new disDev.AnimationLite(2, "lz", 0, 3, 1, (!1)), this.ds_anm = new disDev.AnimationLite(2, "lz", 2, 3, 1, (!1)), this.lh0_anm = new disDev.AnimationLite(2, "lz", 4, 3, 1, (!1)), this.lh1_anm = new disDev.AnimationLite(2, "lz", 4, 3, 1, (!1)), this.lh2_anm = new disDev.AnimationLite(2, "lz", 4, 3, 1, (!1)), this.lh3_anm = new disDev.AnimationLite(2, "lz", 4, 3, 1, (!1)), this.lh4_anm = new disDev.AnimationLite(2, "lz", 4, 3, 1, (!1)), this.luzhuContainer.addChild(this.dx_anm), this.luzhuContainer.addChild(this.ds_anm), this.luzhuContainer.addChild(this.lh0_anm), this.luzhuContainer.addChild(this.lh1_anm), this.luzhuContainer.addChild(this.lh2_anm), this.luzhuContainer.addChild(this.lh3_anm), this.luzhuContainer.addChild(this.lh4_anm), this.dx_anm.scaleX = this.dx_anm.scaleY = 1 / .7, this.ds_anm.scaleX = this.ds_anm.scaleY = 1 / .7, this.lh0_anm.scaleX = this.lh0_anm.scaleY = 1 / .7, this.lh1_anm.scaleX = this.lh1_anm.scaleY = 1 / .7,this.lh2_anm.scaleX = this.lh2_anm.scaleY = 1 / .7,this.lh3_anm.scaleX = this.lh3_anm.scaleY = 1 / .7,this.lh4_anm.scaleX = this.lh4_anm.scaleY = 1 / .7,this.dx_anm.x = 480,this.dx_anm.y = 573,this.ds_anm.x = 535,this.ds_anm.y = 573,this.lh0_anm.x = 657,this.lh0_anm.y = 573,this.lh1_anm.x = 711,this.lh1_anm.y = 573,this.lh2_anm.x = 765,this.lh2_anm.y = 573,this.lh3_anm.x = 819,this.lh3_anm.y = 573,this.lh4_anm.x = 875,this.lh4_anm.y = 573,this.numArray = new Array(10);
            ...
            this.isInit && (this.isInit = !1,
                "iOS" == egret.Capabilities.os ? (popup("很抱歉，由于IOS系统不允许浏览器自动播放音频，请手动打开音效开关。"),
                    SoundEffectManager.isOpen = !1,
                    this.soundBtnClose.visible = this.closeBitmap.visible = !0) : "Android" == egret.Capabilities.os ? AboutBrowser.info.isAutoPlaySound ? this.soundBtnOpen.visible = this.openShape.visible = !0 : (popup("很抱歉，您当前所使用的浏览器不支持自动播放音频，请手动打开音效开关。"),
                    SoundEffectManager.isOpen = !1,
                    this.soundBtnClose.visible = this.closeBitmap.visible = !0) : this.soundBtnOpen.visible = this.openShape.visible = !0),
                    this.next_periodNumber_txt.text = localData.Cache.data.next.periodNumber,
                    this.next_awardTime_txt.text = localData.Cache.data.next.awardTime.split(" ")[1],
                    this.getCurrentPeriodNumber(), this.getCurrentResult(), this.getAwardTimeInterval(),
                    CommonVariable.awardStatus == 0  && (CommonVariable.timeInterval -= 1, this.clockProxy.startRun(), this.clockProxy.show())
            ...
            if (!CommonVariable.isSimulating) {
                localData.Cache.data.current.period = localData.Cache.data.next.period, this.next_periodNumber_txt.text = "开奖中", this.next_awardTime_txt.text = "开奖中", this.current_awardTime_txt.text = localData.Cache.data.next.awardTime.split(" ")[1]/*, this.current_periodNumber_txt.text = localData.Cache.data.next.periodNumber*/, this.luzhuContainer.visible = !1;
            ...
            SoundEffectManager.isOpen = !0,
                CommonVariable.awardStatus < 2.5 ? SoundEffectManager.playSound(SoundNames.BGM_GAME, 0, 0) :
                    CommonVariable.awardStatus > 2.5 && CommonVariable.awardStatus < 4 && SoundEffectManager.playSound(SoundNames.RUNNING, 0, 0),
                this.soundBtnOpen.visible = !0, this.soundBtnClose.visible = !1, this.openShape.visible = !0, this.closeBitmap.visible = !1
        }, e
    }();
    ...
    var t = function () {
        ...
        return r.subscribe = function (e, t, i) {
            ...
            this.infoView = new e.InfoView(this.infoLayer), this.rankView = new e.RankView(this.localEffectLayer), this.gameView = new e.GameView(this.gameLayer)
                    ...
                    CommonVariable.isSimulating ? this.timeID = setTimeout(this.getResult.bind(this), 18e3) : this.timeID = setTimeout(this.getResult.bind(this), 8e3),
                    CommonVariable.takeSpaceCount = 0,
                    this.takeSpaceCount = 0
            ...
            if (clearTimeout(this.timeID), clearInterval(this.timeID), CommonVariable.isSimulating) {
                ...
                //console.log(ConcreteSubject.notify(SubjectTypes.TAKE_REALDATA, t));
            } else dataReq.DataRequester.getData(), this.timeID = setInterval(dataReq.DataRequester.getData, 1e3)
            //console.log(dataReq.DataRequester.getData());
        }, r.getRealData = function () {
            clearTimeout(this.timeID), clearInterval(this.timeID), CommonVariable.awardStatus = 0;
...
var SubjectBase = function () {
    ...
    return i.addObserver = function (e, t, i, r) {
        if (null == i) throw new Error("错误：提供给 ConcreteSubject 的回调函数不能为null");
...
var ConcreteSubject = function () {
    function e() {
        throw new Error(e.__class__ + " 是静态成员集成类，无需实例化")
    }
