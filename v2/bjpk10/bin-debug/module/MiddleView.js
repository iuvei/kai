...
!function (t) {
    var e = function () {
        ...
        return e.prototype.init = function () {
            ...
            a.parseDragonBonesData(RES.getRes("start_ske_json")),
                a.parseTextureAtlasData(RES.getRes("start_tex_json"),
                    RES.getRes("start_tex_png")),
                this._startAnim = a.buildArmatureDisplay("Armature", "start"),
                this._ui.addChildAt(this._startAnim, 1),
                this._startAnim.animation.gotoAndStop("stop"),
                this._startAnim.x = 490,
                this._startAnim.y = 315,
                this.timeLab.filters = [new egret.DropShadowFilter(4, 45, 0, .3, 4, 4, 1)],
                this._lightBmps = new Array(3);
            for (var i = 0; i < 3; i++) this._lightBmps[i] = this._ui["light" + i];
            this._countDownImg.visible = !1,
                this._countDownImg.scaleX = this._countDownImg.scaleY = .95,
                ...
                t.DataEventDispatcher.addEventListener(t.GameEventType.TRY_GAME, this.onTryGame, this)
