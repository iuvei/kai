...
!function (t) {
    var e = function () {
        ...
        return t.getData = function () {
            ...
            n.time = r.datas.present.opentime.toString();
            if(n.current.periodNumber==undefined||n.current.periodNumber==r.datas.last_opencode.expect.toString()){
                CommonVariable.awardStatus = 0;
            }else {
                CommonVariable.awardStatus=2;
            }
            n.current.awardNumbers = r.datas.last_opencode.opencode.toString(),//本期开奖号码
            n.current.periodNumber = r.datas.last_opencode.expect.toString(), //本期期号
            n.current.awardTime = r.datas.present.opentime.toString(),//本期开奖时间
            n.current.awardNumbers = r.datas.last_opencode.opencode.toString(),//本期开奖号码
            n.next.periodNumber = r.datas.present.expect.toString(),//下期期号
            n.next.awardTime = r.datas.present.opentimestamp.toString(),//下期开奖时间
            n.next.awardTimeInterval = r.datas.present.opentime_remaining.toString(),//开奖倒计时
            n.next.delayTimeInterval = r.datas.present.opentime_remaining.toString(),//开奖倒计时
...
!function (t) {
    var e = function (t) {
        ...
        return __extends(e, t), e.prototype.subscribe = function (t, e, r) {
            ...
            this.addChild(t),
                t.texture = RES.getRes("GameBG"),
                t.scaleX = t.scaleY = 1 / .7,
                this.board_mc = new egret.Sprite,
                this.numContainer = new egret.Sprite,
                this.numBGContainer = new egret.Sprite,
                this.recordContainer = new egret.Sprite,
                this.rollContainer = new egret.Sprite,
                this.spriteArray.push(this.board_mc,
                    this.numContainer, this.numBGContainer,
            ...
            for (var e = 0; 5 > e; e++) for (var r = 0; 3 > r; r++) {
                ...
                i.name = "num_h" + e + "s" + r, editHashPair(i.name, i), i.x = 242 + 100 * e, i.y = 220 + 100 * r, i.scaleX = i.scaleY = 1 / .7;//中部开奖结果
                ...
                a.name = "numbg_h" + e + "s" + r, editHashPair(a.name, a), a.texture = RES.getRes("NumBG"), a.x = 242 + 100 * e, a.y = 220 + 100 * r, this.numBGContainer.addChild(a)//黄色底球位置
            }

            for (e = 0; 6 > e; e++) {
                var o = disDev.TextureInfoMaker.createInfo(2, "dx", 0, 3), s = new disDev.AnimationGroup([o], 1, (!1));

                s.name = "dx" + e, editHashPair(s.name, s);
                if (e < 5) {
                    s.x = 242 + 100 * e, s.y = 220, this.recordContainer.addChild(s);//单双位置
                } else {
                    s.x = 647, s.y = 20, s.scaleX = s.scaleY = 4 / 7, this.recordContainer.addChild(s);//单双位置

                }
                o = disDev.TextureInfoMaker.createInfo(2, "ds", 0, 3),
                    s = new disDev.AnimationGroup([o], 1, (!1)),
                    s.name = "ds" + e, editHashPair(s.name, s);
                if (e < 5) {
                    s.x = 242 + 100 * e, s.y = 421, this.recordContainer.addChild(s);//单双位置
                } else {
                    s.x = 700, s.y = 20, s.scaleX = s.scaleY = 4 / 7, this.recordContainer.addChild(s);//单双位置

                }
            }
            for (e = 0; 5 > e; e++) {
                var l = new disDev.AnimationLite(30, "NumRoll", 1, 4);
                l.name = "roll1_" + e, editHashPair(l.name, l), l.anchorOffsetX = 1, l.anchorOffsetY = 1, l.x = 242 + 100 * e, l.y = 218, l.scaleX = l.scaleY = 1 / .7, l.gotoAndStop(Math.ceil(30 * Math.random())), this.rollContainer.addChild(l);//中部开奖中位置
                var c = new disDev.AnimationLite(30, "NumRoll", 1, 4);
                c.name = "roll2_" + e, editHashPair(c.name, c), c.anchorOffsetX = 1, c.anchorOffsetY = 1, c.x = 242 + 100 * e, c.y = 318, c.scaleX = c.scaleY = 1 / .7, c.gotoAndStop(Math.ceil(30 * Math.random())), this.rollContainer.addChild(c);//中部开奖中位置
                var h = new disDev.AnimationLite(30, "NumRoll", 1, 4);
                h.name = "roll3_" + e, editHashPair(h.name, h), h.anchorOffsetX = 1, h.anchorOffsetY = 1, h.x = 242 + 100 * e, h.y = 418, h.scaleX = h.scaleY = 1 / .7, h.gotoAndStop(Math.ceil(30 * Math.random())), this.rollContainer.addChild(h)//中部开奖中位置
            }
...
!function (t) {
    var e = function (t) {
        ...
        return __extends(e, t), e.prototype.subscribe = function (t, e, r) {
            ...
            r.y = 502, this.addChild(r),
                this.he_txt.x = 252,
                this.danshuang_txt.x = 302,
                this.daxiao_txt.x = 353,
                this.longhu_txt.x = 449,
                this.qiansan_txt.x = 555,
                this.zhongsan_txt.x = 621,
                this.housan_txt.x = 686,
                this.xiaqi_txt.width = 200,
                this.shijian_txt.width = 48,
                this.shijian_txt.height=48,
                this.xiaqi_txt.x = 523,
                this.xiaqi_txt.y = 32,
                this.shijian_txt.x = 652,
                this.shijian_txt.y = 28,
                this.addChild(this.xiaqi_txt),
                this.addChild(this.shijian_txt),
                this.xiaqi_txt.fontFamily = "Microsoft YaHei",
                this.xiaqi_txt.bold = !0,
                this.xiaqi_txt.size = 30,
                this.xiaqi_txt.textColor = 255255255,
                this.xiaqi_txt.textAlign = egret.HorizontalAlign.CENTER,
                this.shijian_txt.fontFamily = "Microsoft YaHei",
                this.shijian_txt.bold = !0,
                this.shijian_txt.size = 35,
                this.shijian_txt.textColor = 255255255,
                this.shijian_txt.textAlign=50,
                this.shijian_txt.textAlign = egret.HorizontalAlign.CENTER,
                this.jinqi_txt.fontFamily = "Microsoft YaHei",
                this.jinqi_txt.bold = !0,
                this.jinqi_txt.size = 19,
                this.jinqi_txt.textColor = 15517599,
                this.jinqi_txt.textAlign = egret.HorizontalAlign.CENTER,
                this.jinqi_txt.x = 482,
                this.jinqi_txt.y = 543,
                this.qishu_txt.width = 250,
                this.qishu_txt.fontFamily = "Microsoft YaHei",
                this.qishu_txt.bold = !0,
                this.qishu_txt.size = 23,
                this.qishu_txt.textColor = 15517599,
                this.qishu_txt.textAlign = egret.HorizontalAlign.CENTER,
                this.qishu_txt.x = 740,
                this.qishu_txt.y = 34,
                this.moni_txt.fontFamily = "Microsoft YaHei",
                this.moni_txt.bold = !0,
                this.moni_txt.size = 25,
                this.moni_txt.textColor = 15517599,
                this.moni_txt.textAlign = egret.HorizontalAlign.CENTER,
                this.moni_txt.x = 785,
                this.moni_txt.y = 34,
                this.moni_txt.text = "模拟开奖",
                this.addChild(this.jinqi_txt),
                this.addChild(this.qishu_txt),
                this.addChild(this.moni_txt),
                this.addChild(this.bit0),
                this.addChild(this.bit1),
                this.addChild(this.bit2),
                this.addChild(this.bit3),
                this.addChild(this.bit4),
                this.moni_txt.visible = !1;
            for (var i = 0; 5 > i; i++) this["bit" + i].scaleX = this["bit" + i].scaleY = .20 / .30, this["bit" + i].x = 230 + 61 * i, this["bit" + i].y = 25;//顶部开奖号码
            this.laba_open = new disDev.ButtonLite("laba000", "laba001"),
                this.laba_open.x = 153, this.laba_open.y = 180,
                this.laba_close = new disDev.ButtonLite("laba002", "laba003"),
                this.laba_close.x = 153, this.laba_close.y = 180,
                this.addChild(this.laba_close),
                this.laba_open.touchEnabled = !0,
                this.laba_close.touchEnabled = !0
        }, e.prototype.addEvents = function () {
            ...
            this.jinqi_txt.visible = !1, CommonVariable.isSimulating ? (this.qishu_txt.visible = !1, this.moni_txt.visible = !0,this.xiaqi_txt.text = "?", this.shijian_txt.text = "") : (this.xiaqi_txt.text = "?", this.shijian_txt.text = "", this.qishu_txt.text = "开奖中", this.he_txt.text = "", this.danshuang_txt.text = "", this.daxiao_txt.text = "", this.longhu_txt.text = "", this.qiansan_txt.text = "", this.zhongsan_txt.text = "", this.housan_txt.text = "");
            ...
            var hm_he = Number(e[0]) + Number(e[1])+ Number(e[2])+ Number(e[3])+ Number(e[4]);
            if(hm_he>=23){
                this.shijian_txt.text = "";
            }else {
                this.shijian_txt.text = "";
            };
            ...
            var t = localData.Cache.data;
            var e = CommonVariable.resultArray;
            var hm_he = Number(e[0]) + Number(e[1])+ Number(e[2])+ Number(e[3])+ Number(e[4]);
            if(hm_he>=23){
                this.shijian_txt.text = "";
            }else {
            ...
            this.xiaqi_txt.text = hm_he,this.qishu_txt.text = "本期" + t.current.periodNumber;
    ...
    var e = function () {
        ...
        return t.prototype.subscribe = function (t, e, r) {
            ...
            for (var t = 0; 5 > t; t++) {
                ...
                r.visible = !0,
                    r.userData.visible = !1,
                    this.mcGoto(r, e),
                    r = this.numContainer.getChildByName("num_h" + t + "s0"),
                    this.mcGoto(r, e - 1),
                    r = this.numContainer.getChildByName("num_h" + t + "s2"),
                    this.mcGoto(r, e + 1);
                var i = this.recordContainer.getChildByName("dx" + t);
                e > 4 ? i.gotoAndStop(1) : i.gotoAndStop(2);

                var b = CommonVariable.resultArray;
                var hm_he = Number(b[0]) + Number(b[1])+ Number(b[2])+ Number(b[3])+ Number(b[4]);
                var i = this.recordContainer.getChildByName("dx" + 5);
                hm_he >= 23 ? i.gotoAndStop(1) : i.gotoAndStop(2);

                var n = this.recordContainer.getChildByName("ds" + t);
                e % 2 == 0 ? n.gotoAndStop(1) : n.gotoAndStop(2);

                var b = CommonVariable.resultArray;
                var hm_he = Number(b[0]) + Number(b[1])+ Number(b[2])+ Number(b[3])+ Number(b[4]);
                var i = this.recordContainer.getChildByName("ds" + 5);
                hm_he % 2 == 0 ? i.gotoAndStop(1) : i.gotoAndStop(2);

                    r = getHashObject("num_h" + t + "s0"),
                    r.visible = !1,
                    r = getHashObject("num_h" + t + "s2"),
                    r.visible = !1,
                    r = getHashObject("dx" + t);
                    r.visible = !0;
                    r = getHashObject("dx" + 5);
                    r.visible = !0;
                    r = getHashObject("ds" + t), r.visible = !0;
                    r = getHashObject("ds" + 5), r.visible = !0;
            ...
            for (var t = 0; 5 > t; t++) TimerDelayCaller.addCallerOnce(null, function (t) {
                ...
                var b = CommonVariable.resultArray;
                var hm_he = Number(b[0]) + Number(b[1])+ Number(b[2])+ Number(b[3])+ Number(b[4]);
                r.gotoAndStop(e > 0 ? e : 10),
                    r = getHashObject("num_h" + t + "s0"),
                    r.visible = !1,
                    r = getHashObject("num_h" + t + "s2"),
                    r.visible = !1,
                    r = getHashObject("dx" + t),
                    r.gotoAndStop(e > 4 ? 1 : 2),
                    r.visible = !0,
                    r = getHashObject("dx" + 5),
                    r.gotoAndStop(hm_he >= 23 ? 1 : 2),
                    r.visible = !0,
                    r = getHashObject("ds" + t),
                    r.gotoAndStop(e % 2 == 0 ? 1 : 2),
                    r.visible = !0,
                    r = getHashObject("ds" + 5),
                    r.gotoAndStop(hm_he % 2 == 0 ? 1 : 2),
                    r.visible = !0,
                    ConcreteSubject.notify(SubjectTypes.GET_NUMBER, t)
            }, this, 2e3 + 100 * t, t)
        }, t
    }();
...
!function (t) {
    var e = function () {
        function t(t) {
            this.sws_b = new disDev.AnimationLite(10, "YellowNum_", 1, 2, 1, (!1)),
                this.sws_s = new disDev.AnimationLite(10, "YellowNum_", 1, 2, 1, (!1)),
                this.sws_g = new disDev.AnimationLite(10, "YellowNum_", 1, 2, 1, (!1)),
                this.lws_s = new disDev.AnimationLite(10, "RedNum_", 1, 2, 8, (!1)),
                this.lws_g = new disDev.AnimationLite(10, "RedNum_", 1, 2, 8, (!1)),
                this.clock_mc = t, this.clock_mc.x = 0, this.clock_mc.y = 0,
                this.clock_mc.scaleX = this.clock_mc.scaleY = 1 / .7,
                this.sws_mc = new egret.Sprite, this.lws_mc = new egret.Sprite;
            ...
            this.clock_mc.reconstruct([e, r, i, n, a], 1, !1),
                this.ht0 = this.clock_mc.getPartHeadAndTailAt(0),
                this.ht1 = this.clock_mc.getPartHeadAndTailAt(1),
                this.ht2 = this.clock_mc.getPartHeadAndTailAt(2),
                this.ht3 = this.clock_mc.getPartHeadAndTailAt(3),
                this.ht4 = this.clock_mc.getPartHeadAndTailAt(4),
                this.clock_mc.setLoopPoint(this.ht2.head + 1,
                    this.ht2.tail + 1),
                this.clock_mc.addFrameScript(this.ht3.tail, this.stopHandler, this),
                this.clock_mc.addChild(this.sws_mc), this.clock_mc.addChild(this.lws_mc),
                this.sws_b.x = 448,//到计时百位
                this.sws_s.x = 471,//倒计时十位
                this.sws_g.x = 495,//倒计时个位
                this.sws_s.y = this.sws_g.y = 140,
                this.sws_b.y =139,
                    this.sws_mc.addChild(this.sws_b),
                this.sws_mc.addChild(this.sws_s),
                this.sws_mc.addChild(this.sws_g),
                this.sws_mc.scaleX = this.sws_mc.scaleY = .7,
                this.lws_s.x = 451, //倒计时十位
                this.lws_g.x = 482,//倒计时个位
                this.lws_s.y = this.lws_g.y = 130,
                this.lws_mc.addChild(this.lws_s),
                this.lws_mc.addChild(this.lws_g),
                this.lws_mc.scaleX = this.lws_mc.scaleY = .7,
                this.subscribe(SubjectTypes.GAME_START,
                    this.onGameStart),
                this.subscribe(SubjectTypes.GAME_INIT, this.init),
                this.subscribe(SubjectTypes.OVER_TIME, this.unInit)
        }
