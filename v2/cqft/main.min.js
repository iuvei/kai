...
!function (t) {
    var e = function (t) {
        ...
        return __extends(e, t), e.prototype.reconstruct = function (t, e, r, i) {
            ...
            this.$isNatureEnter = !1;
            var e = this.$currentFrame;
            this.$currentFrame = Math.floor(t),
                this.$currentFrame < 1 ? this.$currentFrame = 1 : this.$currentFrame > this.$totalFrames && (this.$currentFrame = this.$totalFrames), this.stop(), this.callBackFunctionCollection && this.executeFrameScript && this.callBackFunctionCollection[this.$currentFrame - 1] && e != this.$currentFrame && this.callBackFunctionCollection[this.$currentFrame - 1].call(null)
        }, e.prototype.playHandler = function () {
            if (this.$isPlaying && this.executeDriverType) if (this.$driverType == disTypes.DriverType.FRAME) {
                for (this.currentInterval++; this.currentInterval >= 2 * this.playInterval;) if (this.currentInterval -= this.playInterval, this.autoNextFrame(!1), !this.$isPlaying) return;
                this.currentInterval >= this.playInterval && (this.currentInterval -= this.playInterval, this.autoNextFrame(!0))
...
!function (t) {
    var e = function (t) {
        ...
        return __extends(e, t), e.prototype.subscribe = function (t, e, r) {
            ...
            for (e = 0; 5 > e; e++) {
                var o = disDev.TextureInfoMaker.createInfo(5, "ft", 0, 3),
                    s = new disDev.AnimationGroup([o], 1, (!1));

                s.name = "ft" + e, editHashPair(s.name, s);
                console.log(s);
                s.x = 660, s.y = 35, this.recordContainer.addChild(s);//大小位置
            }
            for (e = 0; 5 > e; e++) {
                ...
                console.log();
                s.x = 242 + 100 * e, s.y = 220, this.recordContainer.addChild(s);//大小位置
            }
            for (e = 0; 6 > e; e++) {
                ...
                if (e < 5) {
                    ...
                    s.x = 530, s.y = 20, s.scaleX = s.scaleY = 4 / 7, this.recordContainer.addChild(s);//单双位置
...
!function (t) {
    var e = function (t) {
        ...
        return __extends(e, t), e.prototype.subscribe = function (t, e, r) {
            ...
            this.xiaqi_txt.text = "",this.qishu_txt.text = "本期" + t.current.periodNumber;
    ...
    var e = function () {
        ...
        return t.prototype.subscribe = function (t, e, r) {
            ...
            for (var t = 0; 5 > t; t++) {
                ...
                cqft % 2 == 0 ? i.gotoAndStop(1) : i.gotoAndStop(2);

                var z = this.recordContainer.getChildByName("ft"+t);
                if(hm_he%4==1){
                    z.gotoAndStop(1)
                }if(hm_he%4==2){
                    z.gotoAndStop(2)
